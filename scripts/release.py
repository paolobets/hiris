...
def git_commit_and_tag(version: str, dry_run: bool) -> None:
    ...
    extra = [p for p in ["hiris/run.sh", "hiris/translations/en.yaml", "hiris/translations/it.yaml", "hiris/app/backends/embeddings.py", "hiris/app/static/index.html", "README.md"] if (ROOT / p).exists()]
    cmds = [
