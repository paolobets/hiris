...
async def handle_get_ha_health(request: web.Request) -> web.Response:
    ...
    # Dashboard di configurazione: nessun cap. I limiti per sezione servono a
    # contenere il prompt dell'LLM, mentre qui l'utente vuole vedere tutto.
    snapshot = health_monitor.get_snapshot(sections, capped=False)
