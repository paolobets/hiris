...
VIEW_TOOL_DEF = {
    ...
    "description": (
        ...
        "scioglie confrontando quell'istante con `sensor.uptime` (quando "
        "esiste), il cui stato E' il momento in cui Home Assistant e' "
        "partito: vicino a quello e' un riavvio, lontano e' un guasto. Se un "
