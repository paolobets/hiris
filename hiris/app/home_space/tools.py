...
VIEW_TOOL_DEF = {
    ...
    "description": (
        ...
        "esempio, non e' quante persone ci sono in casa). Quando manca, il "
        "vocabolario non ha nessuna regola citabile su questo caso: e' "
        "silenzio, non un buco -- non affermare al posto suo. "
