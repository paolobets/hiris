...
VIEW_TOOL_DEF = {
    ...
    "description": (
        ...
        "scioglie confrontando quell'istante con `sensor.uptime`, il cui "
        "stato E' «the date and time when Home Assistant was last started» "
        ...
        "Vicino a quello e' un riavvio; lontano e' un guasto; **in mezzo non "
        "si sceglie, si dice che non si sa**. E se `sensor.uptime` non "
        "esiste -- l'integrazione Uptime e' facoltativa e molte case non "
        "l'hanno -- non si conclude «allora e' un guasto»: si torna a non "
        "affermare, perche' una regola che funziona solo dove il sensore c'e' "
        "mente dappertutto dove non c'e'. Se un "
