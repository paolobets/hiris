...
VIEW_TOOL_DEF = {
    ...
    "description": (
        ...
        "Assistant dichiara, mai dedotta dal dominio) e `stato_presunto: "
        ...
        "di UNA entita' sola porta anche `attributi`: il resto dei valori "
        "grezzi che Home Assistant dichiara per il suo dominio (la "
        "luminosita' di una luce, la posizione di una tapparella, "
        "`options` per un elenco di scelte chiuso) -- non nelle liste di "
        "un'area o di un dispositivo, dove sarebbe rumore su decine di "
        "cose alla volta. "
