...
CONCLUDI_TOOL_DEF = {
    ...
    "description": (
        ...
        "silenzio non vuol dire che nessuno ti legga. Il tuo `testo` arriva "
        "comunque nella chat di chi ti ha fatto la promessa. Se metti "
        "`avvisare` a `true` la notifica alla persona la manda HIRIS per te, "
        "ai suoi dispositivi se ha un telefono collegato: qui non esiste uno "
        "strumento per notificare, e non serve -- chiamare «conclude» E' il "
        "modo di avvisarla. `testo` e' cio' che le diresti: una o due frasi, "
        "con i numeri veri e le loro unita', non un riassunto vago; ed e' "
        "anche cio' che le arriva nella notifica. Non puoi toccare la casa da qui: se la risposta "
