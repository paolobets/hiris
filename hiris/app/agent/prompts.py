...
_GUIDE_WITH_TOOLS = (
    ...
    "chiamare `mcp__hiris__cerca` per qualcosa che hai gia'.\n"
    ...
    "piu' `mcp__hiris__legami` -- puoi chiamarle IN PARALLELO nella stessa "
    ...
    "`mcp__hiris__cerca` (vedi sopra) ed essere parsimoniosi con le "
