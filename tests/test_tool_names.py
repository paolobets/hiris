...
_NOMI_MAI_STATI_STRUMENTO = frozenset({
    ...
    # fetta «le tracce e il log» (Task 5, 05/09): due strumenti nuovi, non
    # una rinomina -- entrano qui perche' il catalogo di oggi deve essere
    # un SOTTOINSIEME di questo elenco (vedi
